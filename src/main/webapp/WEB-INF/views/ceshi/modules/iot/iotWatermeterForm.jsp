...
<body>
	<ul class="nav nav-tabs my-nav-tabs">
		...
		<li class="active"><a href="${ctx}/iot/iotWatermeter/form?id=${iotWatermeter.id}">水表<shiro:hasPermission name="iot:iotWatermeter:edit">${not empty iotWatermeter.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="iot:iotWatermeter:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<div class="my-container">
		<form:form id="inputForm" modelAttribute="iotWatermeter" action="${ctx}/iot/iotWatermeter/save" method="post" class="form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="watermeterType" htmlEscape="false" maxlength="50" class="input-xlarge "/>
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="watermeterStatus" htmlEscape="false" maxlength="25" class="input-xlarge "/>
			...
			<div class="control-group">
				...
				<div class="controls">
					<form:input path="installedTime" htmlEscape="false" maxlength="50" class="input-xlarge "/>

...
<body>
	<ul class="nav nav-tabs my-nav-tabs">
		...
		<li class="active"><a href="${ctx}/iot/iotWatermeterVpt/form?id=${iotWatermeterVpt.id}">水表流量阈值<shiro:hasPermission name="iot:iotWatermeterVpt:edit">${not empty iotWatermeterVpt.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="iot:iotWatermeterVpt:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<div class="my-container">
		...
		<%--	<div class="control-group">
			...
			<div class="form-actions my-form-actions">
				<shiro:hasPermission name="iot:iotWatermeterVpt:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>

...
<head>
    ...
    <link type="text/css" href="${ctxStatic}/videomonitor/comom.css" rel="stylesheet"/>
    ...
    <script>
        document.write("<link type='text/css' href='${ctxStatic}/videomonitor/viewVm.css?version=" + new Date().getTime() + "' rel='stylesheet' />");
    </script>
    <script>
        window.onload = function () {
            var toolbox = document.getElementById('toolbox');
            toolbox.setAttribute('style', 'height:' + window.innerHeight + 'px');
        };
        var iotVideoMonitorConfig = ${iotVideoMonitor};
//        console.log(iotVideoMonitorConfig)
    </script>
</head>
<body>
<div class="left">
...
<div id="toolbox" class="my-toolbox" style="">
    ...
    <fieldset class="ptz">
        ...
        <div class="circle open">
            <div class="ring">
                <a href="javascript:void(0)" class="menuItem" title="上" onmousedown="mouseDownPTZControl(1);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-shang"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="右上" onmousedown="mouseDownPTZControl(7);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-youshang"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="右" onmousedown="mouseDownPTZControl(4);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-iconfont63"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="右下" onmousedown="mouseDownPTZControl(8);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-youxia"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="下" onmousedown="mouseDownPTZControl(2);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-xia"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="左下" onmousedown="mouseDownPTZControl(6);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-zuoxia"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="左" onmousedown="mouseDownPTZControl(3);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-iconfont64"></i></a>
                <a href="javascript:void(0)" class="menuItem" title="左上" onmousedown="mouseDownPTZControl(5);" onmouseup="mouseUpPTZControl();"><i class="icon iconfont icon-zuoshang"></i></a>
            </div>
            <a href="javascript:void(0)" class="center" title="自动" onclick="mouseDownPTZControl(9);"><i class="icon iconfont icon-zidong"></i></a>
        </div>
        <%--<table cellpadding="0" cellspacing="3" border="0">
            <tr>
                <td>
        ...
        <div class="operation">
            <button class="button button2 " onmousedown="PTZZoomout()" onmouseup="PTZZoomStop()"><i class="icon iconfont icon-jian"></i></button>
            <button class="button">变倍</button>
            <button class="button button3" onmousedown="PTZZoomIn()" onmouseup="PTZZoomStop()"><i class="icon iconfont icon-jia"></i></button>
            <p style="clear:both;height: 6px;"></p>
            <button class="button button2 " onmousedown="PTZFoucusOut()" onmouseup="PTZFoucusStop()"><i class="icon iconfont icon-jian"></i></button>
            <button class="button">变焦</button>
            <button class="button button3" onmousedown="PTZFocusIn()" onmouseup="PTZFoucusStop()"><i class="icon iconfont icon-jia"></i></button>
            <p style="clear:both;height: 6px;"></p>
            <button class="button button2 " onmousedown="PTZIrisOut()" onmouseup="PTZIrisStop()"><i class="icon iconfont icon-jian"></i></button>
            <button class="button">光圈</button>
            <button class="button button3" onmousedown="PTZIrisIn()" onmouseup="PTZIrisStop()"><i class="icon iconfont icon-jia"></i></button>
        </div>
    ...
    <div style="display: none;">
        <fieldset class="login">
            ...
            <table cellpadding="0" cellspacing="3" border="0">
                ...
                <tr>
                    <td class="tt">IP地址(lszz2c.6655.la)</td>
                    <td><input id="loginip" type="text" class="txt" value="lszz2c.6655.la"/></td>
                    <td class="tt">端口号</td>
                    <td><input id="port" type="text" class="txt" value="81"/></td>
                </tr>
                <tr>
                    <td class="tt">用户名</td>
                    <td><input id="username" type="text" class="txt" value="admin"/></td>
                    <td class="tt">密码</td>
                    <td><input id="password" type="text" class="txt" value="a123456789"/></td>
                </tr>
                <tr>
                    <td colspan="4">
            ...
            <table cellpadding="0" cellspacing="3" border="0">
                ...
                <tr>
                    <td colspan="4"><input type="button" class="btn" value="获取"
                                           onclick="clickGetLocalCfg();"/>&nbsp;<input type="button" class="btn"
                                                                                       value="设置"
...
<script src="${ctxStatic}/videomonitor/demo/jquery-1.7.1.min.js"></script>
<script src="${ctxStatic}/videomonitor/demo/codebase/webVideoCtrl.js"></script>
<script src="${ctxStatic}/videomonitor/viewVm.js"></script>
<script>

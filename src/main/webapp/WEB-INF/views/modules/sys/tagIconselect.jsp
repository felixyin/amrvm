...
<div id="icons2">
	...
	<ul class="the-icons">
		...
		<li>
			<i class="icon iconfont icon-iconfont63"></i>
			<div class="name">右</div>
			<div class="fontclass">.icon-iconfont63</div>
		</li>

		<li>
			<i class="icon iconfont icon-yongshuiliang"></i>
			<div class="name">用水量</div>
			<div class="fontclass">.icon-yongshuiliang</div>
		</li>

		<li>
			<i class="icon iconfont icon-zidong"></i>
			<div class="name">自动</div>
			<div class="fontclass">.icon-zidong</div>
		</li>
		...
		<li>
			<i class="icon iconfont icon-jcsl"></i>
			<div class="name">进厂水量</div>
			<div class="fontclass">.icon-jcsl</div>
		</li>

		<li>
			<i class="icon iconfont icon-xiangmugailan-yongshuiliang"></i>
			<div class="name">项目概览-用水量</div>
			<div class="fontclass">.icon-xiangmugailan-yongshuiliang</div>
		</li>

		<li>
			<i class="icon iconfont icon-yuzhi"></i>
			<div class="name">阈值</div>
			<div class="fontclass">.icon-yuzhi</div>
		</li>
		...
		<li>
			<i class="icon iconfont icon-benyueshuiliang"></i>
			<div class="name">本月水量</div>
			<div class="fontclass">.icon-benyueshuiliang</div>
		</li>

		<li>
			<i class="icon iconfont icon-jinrishuiliang"></i>
			<div class="name">今日水量</div>
			<div class="fontclass">.icon-jinrishuiliang</div>
		</li>

		<li>
			<i class="icon iconfont icon-shipinchakan"></i>
			<div class="name">视频查看</div>
			<div class="fontclass">.icon-shipinchakan</div>
		</li>
		...
		<li>
			<i class="icon iconfont icon-new_shuibiao"></i>
			<div class="name">水表</div>
			<div class="fontclass">.icon-new_shuibiao</div>
		</li>

		<li>
			<i class="icon iconfont icon-chushuiliang"></i>
			<div class="name">出水量</div>
			<div class="fontclass">.icon-chushuiliang</div>
		</li>

		<li>
			<i class="icon iconfont icon-jinshuiliang"></i>
			<div class="name">进水量</div>
			<div class="fontclass">.icon-jinshuiliang</div>
		</li>

		<li>
			<i class="icon iconfont icon-zhuchangtianchong"></i>
			<div class="name">猪场填充</div>
			<div class="fontclass">.icon-zhuchangtianchong</div>
		</li>

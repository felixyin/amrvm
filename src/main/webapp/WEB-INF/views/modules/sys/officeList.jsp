	...
	<script type="text/template" id="treeTableTpl">
		<tr id="{{row.id}}" pId="{{pid}}">
			...
			<shiro:hasPermission name="sys:office:edit"><td>
				<a style="color: #0b2c89" href="${ctx}/sys/office/form?id={{row.id}}">修改</a>
				<a style="color: #0b2c89" href="${ctx}/sys/office/delete?id={{row.id}}" onclick="return confirmx('要删除该机构及所有子机构项吗？', this.href)">删除</a>
				<a style="color: #0b2c89" href="${ctx}/sys/office/form?parent.id={{row.id}}">添加下级机构</a>

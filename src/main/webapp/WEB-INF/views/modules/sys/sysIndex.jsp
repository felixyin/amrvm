...
<head>
    ...
    <script type="text/javascript">
        ...
        function showInMainFrame(owner) {
            ...
            url = url || '/amrvm/a/iot/iotWatermeterReport/index'; // 默认显示首页
...
<div id="main">
        ...
        <div class="navbar-inner topbg">
            ...
            <ul id="userControl" class="nav pull-right">
                ...
                <li id="userInfo" class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${ctx}/sys/user/info" target="mainFrame" onclick="showInMainFrame(event);"><i class="icon-user"></i>&nbsp; 个人信息</a>
                        </li>
                        <li><a href="${ctx}/sys/user/modifyPwd" target="mainFrame" onclick="showInMainFrame(event);"><i class="icon-lock"></i>&nbsp; 修改密码</a>
                        </li>
    ...
    <div class="container-fluid">
        ...
        <div id="footer" class="row-fluid">
            Copyright &copy; 2018-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By 青岛普尔赛斯信息技术有限公司 ${fns:getConfig('version')}
        </div>
    </div>
</div>
<script type="text/javascript">
